...
\include{tabs/error_sum.tex}

\include{tabs/parking_sum.tex}
...
\includegraphics[scale=.9]{data/treats/Mistakes_Dem.png}
...
\centering
\caption{Mistakes}
\includegraphics[scale=.9]{data/treats/Mistakes_Rep.png}
...
\centering
\caption{Parking Lot}
\includegraphics[scale=.9]{data/treats/Parking_Lot_Dems.png}
\label{fig:mistakes_rep}
\end{figure}
