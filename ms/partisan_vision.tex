...
\author{Gaurav Sood\thanks{Gaurav can be reached at, \href{mailto:gsood07@gmail.com}{\texttt{gsood07@gmail.com}}} \and Alex Theodoridis\thanks{Alex can be reached at \href{alexandertheodoridis@gmail.com}{\texttt{alexandertheodoridis@gmail.com}}}}
...
\noindent In the current era of partisan polarization, partisanship strongly colors partisans' worldview. But does it cause partisans to \textit{see} things differently \citep{chabris2010invisible}? We test the hypothesis in two different experiments and a survey and consistently find that the effect is small.
\end{abstract}
